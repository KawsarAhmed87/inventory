              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Edit Supplier <button class="btn btn-default btn-sm"><router-link to="/supplier">List</router-link></button></h1>
                  </div>
                  <form class="user" @submit.prevent="supplierInsert" enctype="multipart/form-data"> 
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" v-model="form.shopname" placeholder="Shop name">
